...
'    <h3 id="load-tracks-label">Load GeoJSON Tracks</h3>' +
'  </div>' +
'  <div class="modal-body">' +
'    <p>' +
'      Supports GeoJSON. See description of format: <a href="https://github.com/hallahan/LeafletPlayback#gps-data-format">https://github.com/hallahan/LeafletPlayback</a>'  +
'    </p>' +
  ...
  _loadTracksFromFile: function(file) {
    ...
    reader.onload = function(e) {
      ...
      try {
        ...
        console.error('Unable to load GeoJSON tracks!');
      }
